...
const Logo = ({ className = "" }) => (
  ...
  >
    ...
    <g>
      <clipPath id="lc1"><rect x="713.021" y="858.333" width="4574.479" height="1654.167"/></clipPath>
      <g clipPath="url(#lc1)">
...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    if (authError) { setError("Credenciales incorrectas. Intenta de nuevo."); setLoading(false); return; }
    setPhase("leaving");
